    ...
    async def run(self, run_id: int, channel_id: int, auto_pick: bool = False,
        ...
        if auto_pick:
            ...
            await workflow.wait_condition(
                lambda: self._selected_clip_index is not None or self._rejected)
            if self._rejected:
                return {"status": "rejected", "reason": "All clips rejected by user"}
        ...
        # 7. Mark as pending human review instead of auto-publishing
