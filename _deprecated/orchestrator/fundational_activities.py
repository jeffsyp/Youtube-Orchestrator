...
async def pick_fundational_concepts(run_id: int, channel_id: int) -> list[dict]:
    ...
    if USE_REAL_WRITING:
        ...
        from packages.prompts.fundational import build_fundational_ideas_prompt, _SYSTEM as FUND_RULES
...
async def prescreen_fundational_clips(run_id: int, channel_id: int, clips: list[str], concept: dict) -> list[dict]:
    ...
    for i, clip_path in enumerate(clips):
        ...
        review_prompt = build_review_prompt(concept, "Fundational", "AI step-by-step building", video_feedback=video_fb or None)
